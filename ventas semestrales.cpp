...
cout<<"Clave   Nombre  Mayo  Junio  Julio  Agosto  Septiembre  Octubre  Salario  Ventas ";
for(x=0;x<a;x++)
{
cout<<"\n"<<datosempleado[x].ne<<"\t";
...
float ventamenor()
{cout<<"Los empleados con ventas menores a 30000 fueron: ";
cout<<"Clave     Nombre   Venta\n";
for(x=0;x<a;x++)
{if(datosempleado[x].venta6<30000)
{cout<<datosempleado[x].ne<<"\t"<<datosempleado[x].nombre<<"\t"<<datosempleado[x].venta6<<endl;
}
}
return(0);
}
